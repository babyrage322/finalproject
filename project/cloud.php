	...
	<div class="main">
		...
		<ul id="carousel" class="elastislide-list">
			...
			<div class="site_content">
				...
				<div class="content">
					<h1>Выживший</h1>
					<video width="560" height="315" controls="controls"> <source src="video/revenant.mp4" type='video/mp4' > </video>
					<div class="info_film_page">
						<span class="label">рейтинг:</span><span class="value"> 8.2 / 10</span>
						<span class="label">год:</span><span class="value"> 2015</span>
						<span class="label">режисссер:</span><span class="value"> Алехандро Г. Иньярриту</span>
					</div>
					<hr>
					<h2>Описание фильма</h2>
					<div class="description_film">
						<img src="assets/img/cloud.png" width="150" height="200">
