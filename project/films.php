			...
			<div class="site_content">
				...
				<div class="content">
					<div class="info_film">
						...
						«Интерстéллар» — научно-фантастический фильм режиссёра Кристофера Нолана по сценарию Джонатана Нолана и физика-теоретика Кипа Торна. Фильм повествует о путешествиях группы исследователей, которые используют недавно обнаруженный пространственно-временной тоннель.
						<div class="button">
							<a href="interstellar.php">Смотреть</a>
						</div>
					</div>
					<div class="info_film">
						<img src="assets/img/cloud.png">
						«Вы́живший» (англ. The Revenant) — американский эпический остросюжетный вестерн 2015 года режиссёра Алехандро Г. Иньярриту. Адаптированный сценарий по одноимённому роману Майкла Панке 2002 года был написан Иньярриту и Марком Л. Смитом и частично основан на жизни маунтинмена Хью Гласса. 
						<div class="button">
							<a href="cloud.php">Смотреть</a>
						</div>
					</div>
					<div class="info_film">
						<img src="assets/img/max.png">
						«Дэдпул» (англ. Deadpool) — американский комедийный фантастический боевик с Райаном Рейнольдсом в главной роли, снятый режиссёром Тимом Миллером на основе комиксов о персонаже Marvel Comics Дэдпуле.
						<div class="button">
							<a href="mad.php">Смотреть</a>
						</div>
					</div>
					<div class="info_film">
						<img src="assets/img/matrix.png">
						«Зверопо́лис» (англ. Zootopia) — компьютерно-анимационный комедийный фильм студии Walt Disney Animation Studios. Создатели — режиссёры Байрон Ховард («Рапунцель: Запутанная история»), Рич Мур («Ральф»), Джаред Буш («Супергерой на полставки») и продюсер Кларк Спенсер («Лило и Стич», «Вольт» и «Ральф»). Это 55-й анимационный фильм студии.
						<div class="button">
							<a href="matrix.php">Смотреть</a>
						</div>
					</div>
				</div>
			</div>
