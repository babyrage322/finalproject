	...
	<div class="main">
		...
		<ul id="carousel" class="elastislide-list">
			...
			<div class="site_content">
				...
				<div class="content">
					<h1>Интерстеллар</h1>
					<video width="560" height="315" controls="controls"> <source src="video/inter.mp4" type='video/mp4' > </video>
					<div class="info_film_page">
						<span class="label">рейтинг:</span><span class="value"> 8.6 / 10</span>
						<span class="label">год:</span><span class="value"> 2014</span>
						<span class="label">режисссер:</span><span class="value"> Кристофер Нолан</span>
					</div>
					<hr>
