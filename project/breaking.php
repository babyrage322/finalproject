	...
	<div class="main">
		...
		<ul id="carousel" class="elastislide-list">
			...
			<div class="site_content">
				...
				<div class="content">
					<h1>Во все тяжкие</h1>
					<video width="560" height="315" controls="controls"> <source src="video/breaking.mp4" type='video/mp4' > </video>
					<div class="info_film_page">
						<span class="label">рейтинг:</span><span class="value"> 9.5 / 10</span>
						<span class="label">год:</span><span class="value"> с 2008</span>
						<span class="label">режиссер:</span><span class="value"> Винс Гиллиган</span>
					</div>
					<hr>
					<h2>Описание сериала</h2>
					...
					<h2>Чтобы оставить комментарий войдите в систему</h2>
